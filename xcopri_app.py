...
def build_me_df(selected_frozen: tuple, df_json: str, taper_drug: str = None) -> pd.DataFrame:
    """AM/PM dose breakdown. Cached via frozen inputs."""
    import json
...
with tab4:
    ...
    if not sd:
        ...
        st.dataframe(build_me_df(sd_no_taper_frozen, base_df.to_json(), taper_drug=taper_drug), use_container_width=True, hide_index=True)
