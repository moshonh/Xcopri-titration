...
REFERENCES = {
    "Sperling2020":         "Sperling MR et al. Epilepsia 2020;61:1099-1108. PMID:32162327",
    "Krauss2020":           "Krauss GL et al. Lancet Neurol. 2020;19:38-48. PMID:31734103",
    "Roberti2021":          "Roberti R et al. CNS Drugs 2021;35:609-618. PMID:33966208",
    "Smith2022":            "Smith MC et al. Neurol Ther. 2022;11:1705-1720. PMID:35962907",
    "Steinhoff2024":        "Steinhoff BJ et al. Ther Adv Neurol Disord. 2024;17:17562864241256733. PMID:38919279",
    "Osborn2023":           "Osborn M & Abou-Khalil B. Epilepsy Behav. 2023;142:109156. PMID:36963163",
    "Schoretsanitis2022":   "Schoretsanitis G et al. Expert Opin Drug Metab Toxicol. 2022;18:395-411. PMID:35849051",
    "Karazniewicz2021":     "Karazniewicz-Lada M et al. Int J Mol Sci. 2021;22:9582. PMID:34502492",
    "Operto2025":           "Operto FF et al. Front Pharmacol. 2025;16:1668382",
    "Krauss2025":           "Krauss GL et al. Epilepsia. 2025;66 Suppl 1:15-28. PMID:39887568",
    "Zaccara2021":          "Zaccara G et al. Neuropsychiatr Dis Treat. 2021;17:3447-3457. PMID:34938073",
    "Landmark2026":         "Johannessen Landmark C et al. Epilepsia. 2026;67:2820-2835",
    "Charlier2026":         "Charlier B et al. Pharmaceutics. 2026;18:92",
    "Cohen2026":            "Cohen H et al. Epileptic Disord Int Epilepsy J Videotape. 2026;28:855-867",
    "Samanta2025":          "Samanta D. Epilepsy Behav. 2025;173:110787. PMID:39818154",
    "AbouKhalil2022":       "Abou-Khalil BW. Continuum. 2022;28:500-535. PMID:35393970",
    "Ciullo2026":           "Ciullo I et al. Epilepsia Open. 2026;11:962-972",
    "FDA2019":              "US Food and Drug Administration. XCOPRI prescribing information [updated August 2025]. FDA; 2025",
...
PAPER_LIST = [
    ("Sperling MR et al.", "2020",
     "Cenobamate (YKP3089) as adjunctive treatment for uncontrolled focal seizures — Phase 3 open-label safety study",
    ...
    ("Krauss GL et al.", "2020",
     "Safety and efficacy of adjunctive cenobamate (YKP3089) in patients with uncontrolled focal seizures — Phase 3 RCT",
    ...
    ("Roberti R et al.", "2021",
     ...
     "Primary PK/DDI reference: CYP2C19 inhibition, CYP3A4/2B6/UGT induction."),
    ("Smith MC et al.", "2022",
     "Dose adjustment of concomitant antiseizure medications during cenobamate treatment: expert opinion consensus",
     "Neurol Ther", "10.1007/s40120-022-00400-5", "PMID:35962907",
     "Operationally actionable dose-adjustment percentages for each concomitant ASM."),
    ("Steinhoff BJ et al.", "2024",
     ...
     "Consensus on titration pace, DRESS prevention, SCB proactive discontinuation."),
    ("Osborn M & Abou-Khalil B", "2023",
     ...
     "Defines norclobazam (N-CLB) elevation and pharmacodynamic synergy; basis for 20 mg dose-threshold rule."),
    ("Schoretsanitis G et al.", "2022",
     ...
     "Basis for hormonal contraceptive interaction guidance (Tab 1 warning)."),
    ("Karazniewicz-Lada M et al.", "2021",
     "Pharmacokinetic drug-drug interactions among antiepileptic drugs, including CBD, drugs used to treat COVID-19 and nutrients",
     "Int J Mol Sci", "10.3390/ijms22179582", "PMID:34502492",
     "CBD + cenobamate: additive CYP2C19 inhibition; OXC/CBZ/PHT interaction details."),
    ("Operto FF et al.", "2025",
     "Clinical predictors and concomitant ASM effects on seizure control in relation to plasma cenobamate concentration",
     "Front Pharmacol", "10.3389/fphar.2025.1668382", "",
     "Real-world plasma concentrations; validates bidirectional PK effects in clinical practice."),
    ("Krauss GL et al.", "2025",
     "Improving the tolerability of antiseizure medications: when and how to use cenobamate",
     "Epilepsia", "10.1111/epi.18304", "PMID:39887568",
     "Initiation strategies, QT monitoring, tolerability management at each dose step."),
    ("Zaccara G et al.", "2021",
     ...
     "Safety profile including dose-dependent QT interval shortening."),
    ("Johannessen Landmark C et al.", "2026",
     ...
     "KEY: bidirectional interactions — concomitant ASMs reduce cenobamate trough levels by 20-40%. Vol 67:2820-2835."),
    ("Charlier B et al.", "2026",
     "Do cenobamate pharmacokinetics change with co-administered antiseizure medications? An exploratory analysis",
     "Pharmaceutics", "10.3390/pharmaceutics18010092", "",
     "Quantifies bidirectional effects of CBZ, OXC, LTG on cenobamate trough concentrations."),
    ("Cohen H et al.", "2026",
     "Induction of cytochrome P450 2C9 and P-glycoprotein activity by antiseizure medications: systematic review and network meta-analysis",
     "Epileptic Disord Int Epilepsy J Videotape", "10.1002/epd2.70232", "",
     "CYP2C9 induction and P-glycoprotein effects relevant to phenytoin bidirectional PK. Vol 28:855-867."),
    ("Samanta D", "2025",
     ...
     "Off-label pediatric data; syndrome-specific considerations. Used for off-label flag in Tool."),
    ("Abou-Khalil BW", "2022",
     "Update on antiseizure medications 2022",
     "Continuum (Minneap Minn)", "10.1212/CON.0000000000001104", "PMID:35393970",
     "Broad ASM update including cenobamate mechanism and clinical positioning."),
    ("Ciullo I et al.", "2026",
     "Effectiveness of adjunctive low-dose clobazam in adults with focal drug-resistant epilepsy and incomplete response to cenobamate",
     "Epilepsia Open", "10.1002/epi4.70261", "",
     "Real-world rationale for low-dose clobazam add-on; basis for threshold rule nuance. Vol 11:962-972."),
    ("US Food and Drug Administration", "2025",
     "XCOPRI (cenobamate) Prescribing Information [updated August 2025 — hepatotoxicity/liver failure]",
     "FDA", "https://www.accessdata.fda.gov/drugsatfda_docs/label/2025/212839s013lbl.pdf", "",
     "Official prescribing information: dosing, contraindications, hepatic/renal limits. August 2025 update: hepatotoxicity Black Box."),
    ...
    ("Greene SA et al.", "2022",
     ...
     "Clin Transl Sci", "10.1111/cts.13234", "PMID:38573131",
     "Establishes cenobamate's enzyme-inducing/inhibiting effects at doses up to 200 mg/day — the evidence base for the scope-of-recommendations disclaimer. Vol 15:899-911."),
    ("Villani F et al.", "2022",
...
SAFETY_FLAGS = [
    ...
    },
    {
        ...
        "refs": ["FDA2019", "EMA2021", "Smith2022", "Greene2022"],
...
The developers make no representation or warranty, express or implied, regarding the
accuracy, completeness, reliability, timeliness, or fitness for a particular purpose of
the information, calculations, recommendations, or outputs generated by this tool.

This tool is intended solely as an educational and clinical decision-support resource for
qualified healthcare professionals and is not intended to diagnose, treat, cure, or prevent
any disease. No physician-patient relationship is created through the use of this
application. This tool is designed to aid the prescriber, but does **not substitute** for
that person's clinical judgment and for the need to take into consideration additional
patient-related variables not included in the software algorithm (including, but not limited
to, individual pharmacokinetic variability, CYP2C19 genotype, concurrent non-antiseizure
medications, and co-morbidities beyond those captured in the Patient Profile tab).
...
decisions for individual patients. Users are responsible for independently verifying all
recommendations against current prescribing information, applicable regulatory approvals,
and other relevant clinical resources before implementation.
...
other information obtained through use of this tool. To the fullest extent permitted by
applicable law, the developers and their affiliated institutions shall not be liable for
any direct, indirect, incidental, consequential, special, exemplary, or punitive damages
arising from or related to the use of this tool and by proceeding, the user releases and
discharges the developers of this tool and their affiliated institutions from any and all
such claims.
        """
    )
